...
extern struct btshell_conn btshell_conns[(MYNEWT_VAL_BLE_MAX_CONNECTIONS)];
...
int btshell_pvcy_add(ble_addr_t *addr, uint8_t *irk);
int btshell_pvcy_rmv(ble_addr_t *addr);
