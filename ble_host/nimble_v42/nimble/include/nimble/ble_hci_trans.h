...
#if SUPPORT_LE_AUDIO
typedef int ble_hci_trans_rx_iso_fn(struct os_mbuf *om, void *arg);
#endif
...
int ble_hci_trans_ll_ack_tx(uint8_t *hci_ev);
...
void ble_hci_trans_cfg_ll(ble_hci_trans_rx_cmd_fn *cmd_cb,
                          ...
                          void *acl_arg);
#if SUPPORT_LE_AUDIO
void ble_hci_trans_cfg_ll_iso( ble_hci_trans_rx_iso_fn *acl_cb);
int ble_hci_trans_ll_iso_tx(struct os_mbuf *om);
#endif
/**
