...
void ble_gap_test_case_wl_bad_args()
{
    int rc;
...
void ble_gap_test_case_wl_ctlr_fail()
{
    int i;
...
void ble_gap_test_case_wl_good()
{
    ble_addr_t addrs[] = {
        { BLE_ADDR_PUBLIC, { 1, 2, 3, 4, 5, 6 } },
        { BLE_ADDR_PUBLIC, { 2, 3, 4, 5, 6, 7 } },
...
void ble_gap_test_case_disc_bad_args()
{
...
void ble_gap_test_case_disc_good()
{
    uint8_t adv_data[32];
    uint8_t flags;
...
void ble_gap_test_case_disc_ltd_mismatch()
{
    int rc;
    struct ble_gap_disc_desc desc = {
        .event_type = BLE_HCI_ADV_TYPE_ADV_IND,
...
void ble_gap_test_case_disc_hci_fail()
{
    int fail_idx;
    int limited;
    int rc;
...
void ble_gap_test_case_disc_busy()
{
    static const struct ble_gap_disc_params disc_params = { 0 };
...
void ble_gap_test_case_conn_gen_good()
{
...
void ble_gap_test_case_conn_gen_bad_args()
{
    int rc;
...
void ble_gap_test_case_conn_gen_dflt_params()
{
    static const ble_addr_t peer_addr = {
        BLE_ADDR_PUBLIC,
        { 2, 3, 8, 6, 6, 1 }
...
void ble_gap_test_case_conn_gen_already()
{
...
void ble_gap_test_case_conn_gen_done()
{
    static const struct ble_gap_conn_params conn_params = { 0 };
    static const ble_addr_t peer_addr = {
        BLE_ADDR_PUBLIC,
...
void ble_gap_test_case_conn_gen_busy()
{
    static const struct ble_gap_disc_params disc_params = { 0 };
    static const struct ble_gap_conn_params conn_params = { 0 };
    static const ble_addr_t peer_addr = {
...
void ble_gap_test_case_conn_gen_fail_evt()
{
...
void ble_gap_test_suite_conn_gen()
{
    tu_suite_set_post_test_cb(ble_hs_test_util_post_test, NULL);
...
void ble_gap_test_case_conn_cancel_bad_args()
{
    int rc;
...
void ble_gap_test_case_conn_cancel_good()
{
...
void ble_gap_test_case_conn_cancel_ctlr_fail()
{
    struct hci_le_conn_complete evt;
    int rc;
...
void ble_gap_test_suite_conn_cancel()
{
    tu_suite_set_post_test_cb(ble_hs_test_util_post_test, NULL);
...
void ble_gap_test_case_conn_terminate_bad_args()
{
    int rc;
...
void ble_gap_test_case_conn_terminate_good()
{
    uint8_t peer_addr[6] = { 1, 2, 3, 4, 5, 6 };
...
void ble_gap_test_case_conn_terminate_ctlr_fail()
{
    struct hci_disconn_complete evt;
    int rc;
...
void ble_gap_test_case_conn_terminate_hci_fail()
{
    uint8_t peer_addr[6] = { 1, 2, 3, 4, 5, 6 };
...
void ble_gap_test_suite_conn_terminate()
{
    tu_suite_set_post_test_cb(ble_hs_test_util_post_test, NULL);
...
void ble_gap_test_case_conn_find()
{
...
void ble_gap_test_suite_conn_find()
{
    tu_suite_set_post_test_cb(ble_hs_test_util_post_test, NULL);
...
void ble_gap_test_case_adv_bad_args()
{
    struct ble_gap_adv_params adv_params;
    ble_addr_t peer_addr = { BLE_ADDR_PUBLIC, { 1, 2, 3, 4, 5, 6 }};
...
void ble_gap_test_case_adv_dflt_params()
{
    ble_addr_t peer_addr = { BLE_ADDR_PUBLIC, { 1, 2, 3, 4, 5, 6 }};
...
void ble_gap_test_case_adv_good()
{
    ble_addr_t peer_addr = { BLE_ADDR_PUBLIC, { 1, 2, 3, 4, 5, 6 }};
    int d;
    int c;
...
void ble_gap_test_case_adv_ctlr_fail()
{
    ble_addr_t peer_addr = { BLE_ADDR_PUBLIC, { 1, 2, 3, 4, 5, 6 }};
    int d;
    int c;
...
void ble_gap_test_case_adv_hci_fail()
{
    ble_addr_t peer_addr = { BLE_ADDR_PUBLIC, { 1, 2, 3, 4, 5, 6 }};
    int fail_idx;
    int d;
...
void ble_gap_test_case_stop_adv_good()
{
    ble_addr_t peer_addr = { BLE_ADDR_PUBLIC, { 1, 2, 3, 4, 5, 6 }};
    int d;
    int c;
...
void ble_gap_test_case_stop_adv_hci_fail()
{
    ble_addr_t peer_addr = { BLE_ADDR_PUBLIC, { 1, 2, 3, 4, 5, 6 }};
    int d;
    int c;
...
void ble_gap_test_suite_stop_adv()
{
    tu_suite_set_post_test_cb(ble_hs_test_util_post_test, NULL);
...
void ble_gap_test_case_update_conn_good()
{
...
void ble_gap_test_case_update_conn_verify_params()
{
    /* GOOD */
...
void ble_gap_test_case_update_conn_bad()
{
    ble_gap_test_util_update_no_l2cap(
        ((struct ble_gap_upd_params[]) { {
            .itvl_min = 10,
...
void ble_gap_test_case_update_conn_hci_fail()
{
    ble_gap_test_util_update_no_l2cap(
        ((struct ble_gap_upd_params[]) { {
            .itvl_min = 10,
...
void ble_gap_test_case_update_conn_l2cap()
{
    struct ble_gap_upd_params params = {
        .itvl_min = 10,
        .itvl_max = 100,
...
void ble_gap_test_case_update_peer_good()
{
...
void ble_gap_test_case_update_req_good()
{
...
void ble_gap_test_case_update_req_hci_fail()
{
    ble_gap_test_util_update_req_pos(
        ((struct ble_gap_upd_params[]) { {
            .itvl_min = 50,
...
void ble_gap_test_case_update_req_reject()
{
...
void ble_gap_test_case_update_concurrent_good()
{
    ble_gap_test_util_update_req_concurrent(
        ((struct ble_gap_upd_params[]) { {
            .itvl_min = 10,
...
void ble_gap_test_case_update_concurrent_hci_fail()
{
    ble_gap_test_util_update_req_concurrent(
        ((struct ble_gap_upd_params[]) { {
            .itvl_min = 10,
...
void ble_gap_test_suite_update_conn()
{
    tu_suite_set_post_test_cb(ble_hs_test_util_post_test, NULL);
...
void ble_gap_test_case_update_timeout()
{
    struct ble_gap_upd_params params = {
        .itvl_min = 10,
        .itvl_max = 100,
...
void ble_gap_test_case_conn_timeout_conn_forever()
{
    ble_gap_test_util_init();
...
void ble_gap_test_case_conn_timeout_conn_timeout()
{
    ble_gap_test_util_init();
...
void ble_gap_test_case_conn_forever_conn_timeout()
{
    ble_gap_test_util_init();
...
void ble_gap_test_case_disc_timeout_disc_forever()
{
    ble_gap_test_util_init();
...
void ble_gap_test_case_disc_timeout_disc_timeout()
{
    ble_gap_test_util_init();
...
void ble_gap_test_case_disc_forever_disc_timeout()
{
    ble_gap_test_util_init();
...
void ble_gap_test_case_conn_timeout_disc_timeout()
{
    ble_gap_test_util_init();
...
void ble_gap_test_suite_timeout()
{
    tu_suite_set_post_test_cb(ble_hs_test_util_post_test, NULL);
...
void ble_gap_test_case_mtu_peer()
{
    const uint8_t peer_addr[6] = { 1,2,3,4,5,6 };
    int rc;
...
void ble_gap_test_case_set_cb_good()
{
    const uint8_t peer_addr[6] = { 1,2,3,4,5,6 };
...
void ble_gap_test_case_set_cb_bad()
{
    int rc;
...
void ble_gap_test_suite_set_cb()
{
    tu_suite_set_post_test_cb(ble_hs_test_util_post_test, NULL);
