...
SRAM_CODE int ble_att_clt_rx_error(uint16_t conn_handle, struct os_mbuf **rxom)
{
...
SRAM_CODE int ble_att_clt_tx_mtu(uint16_t conn_handle, uint16_t mtu)
{
...
SRAM_CODE int ble_att_clt_rx_mtu(uint16_t conn_handle, struct os_mbuf **rxom)
{
...
SRAM_CODE int ble_att_clt_tx_find_info(uint16_t conn_handle, uint16_t start_handle,
                         uint16_t end_handle)
{
...
static SRAM_CODE int ble_att_clt_parse_find_info_entry(struct os_mbuf **rxom, uint8_t rsp_format,
...
SRAM_CODE int ble_att_clt_rx_find_info(uint16_t conn_handle, struct os_mbuf **om)
{
#if !NIMBLE_BLE_ATT_CLT_FIND_INFO
    return BLE_HS_ENOTSUP;
#endif
 ...
 * anyway
 */
SRAM_CODE int ble_att_clt_tx_find_type_value(uint16_t conn_handle, uint16_t start_handle,
...
static SRAM_CODE int ble_att_clt_parse_find_type_value_hinfo(
...
SRAM_CODE int ble_att_clt_rx_find_type_value(uint16_t conn_handle, struct os_mbuf **rxom)
{
#if !NIMBLE_BLE_ATT_CLT_FIND_TYPE
    return BLE_HS_ENOTSUP;
#endif
...
SRAM_CODE int ble_att_clt_tx_read_type(uint16_t conn_handle, uint16_t start_handle,
...
SRAM_CODE int ble_att_clt_rx_read_type(uint16_t conn_handle, struct os_mbuf **rxom)
{
#if !NIMBLE_BLE_ATT_CLT_READ_TYPE
    return BLE_HS_ENOTSUP;
#endif
...
SRAM_CODE int ble_att_clt_tx_read(uint16_t conn_handle, uint16_t handle)
{
...
SRAM_CODE int ble_att_clt_rx_read(uint16_t conn_handle, struct os_mbuf **rxom)
{
#if !NIMBLE_BLE_ATT_CLT_READ
    return BLE_HS_ENOTSUP;
#endif
...
SRAM_CODE int ble_att_clt_tx_read_blob(uint16_t conn_handle, uint16_t handle, uint16_t offset)
{
...
SRAM_CODE int ble_att_clt_rx_read_blob(uint16_t conn_handle, struct os_mbuf **rxom)
{
#if !NIMBLE_BLE_ATT_CLT_READ_BLOB
    return BLE_HS_ENOTSUP;
#endif
 ...
 * $read multiple                                                            *
 *****************************************************************************/
SRAM_CODE int ble_att_clt_tx_read_mult(uint16_t conn_handle, const uint16_t *handles,
                         int num_handles)
{
...
SRAM_CODE int ble_att_clt_rx_read_mult(uint16_t conn_handle, struct os_mbuf **rxom)
{
#if !NIMBLE_BLE_ATT_CLT_READ_MULT
    return BLE_HS_ENOTSUP;
#endif
...
SRAM_CODE int ble_att_clt_tx_read_group_type(uint16_t conn_handle,
...
static SRAM_CODE int ble_att_clt_parse_read_group_type_adata(
...
SRAM_CODE int ble_att_clt_rx_read_group_type(uint16_t conn_handle, struct os_mbuf **rxom)
{
#if !NIMBLE_BLE_ATT_CLT_READ_GROUP_TYPE
    return BLE_HS_ENOTSUP;
#endif
...
SRAM_CODE int ble_att_clt_tx_write_req(uint16_t conn_handle, uint16_t handle,
                         struct os_mbuf *txom)
{
...
SRAM_CODE int ble_att_clt_tx_write_cmd(uint16_t conn_handle, uint16_t handle,
                         struct os_mbuf *txom)
{
...
SRAM_CODE int ble_att_clt_rx_write(uint16_t conn_handle, struct os_mbuf **rxom)
{
#if !NIMBLE_BLE_ATT_CLT_WRITE
    return BLE_HS_ENOTSUP;
#endif
...
SRAM_CODE int ble_att_clt_tx_prep_write(uint16_t conn_handle, uint16_t handle,
...
SRAM_CODE int ble_att_clt_rx_prep_write(uint16_t conn_handle, struct os_mbuf **rxom)
{
#if !NIMBLE_BLE_ATT_CLT_PREP_WRITE
    return BLE_HS_ENOTSUP;
#endif
...
SRAM_CODE int ble_att_clt_tx_exec_write(uint16_t conn_handle, uint8_t flags)
{
...
SRAM_CODE int ble_att_clt_rx_exec_write(uint16_t conn_handle, struct os_mbuf **rxom)
{
#if !NIMBLE_BLE_ATT_CLT_EXEC_WRITE
    return BLE_HS_ENOTSUP;
#endif
...
SRAM_CODE int ble_att_clt_tx_notify(uint16_t conn_handle, uint16_t handle,
                      struct os_mbuf *txom)
{
...
SRAM_CODE int ble_att_clt_tx_indicate(uint16_t conn_handle, uint16_t handle,
                        struct os_mbuf *txom)
{
...
SRAM_CODE int ble_att_clt_rx_indicate(uint16_t conn_handle, struct os_mbuf **rxom)
{
#if !NIMBLE_BLE_ATT_CLT_INDICATE
    return BLE_HS_ENOTSUP;
#endif
