 ...
 */
SRAM_CODE static struct ble_gattc_proc *
 ...
 */
SRAM_CODE static ble_gattc_err_fn *
 ...
 * Retrieves the error dispatch entry with the specified op code.
 */
SRAM_CODE static ble_gattc_resume_fn *
...
SRAM_CODE static ble_gattc_tmo_fn *
 ...
 */
SRAM_CODE static struct ble_gatt_error *
...
ble_gattc_write_reliable_tx(struct ble_gattc_proc *proc)
{
    ...
    proc->write_reliable.length =
        atbm_min(max_sz, OS_MBUF_PKTLEN(attr->om) - attr->offset);
